...
window.addEventListener("load", () => {
  ...
  buttons.forEach(button => {
    button.addEventListener("click", function (e) {
      ...
      if (cat === "all") displayMenuItems(menu);
      else return displayMenuItems(filterItems);
    });
  });
});

const displayMenuItems = function (menu) {
